...
namespace TestAppUniversal
{
    ...
    public class MixpanelClientTest
    {
        ...
        [TestMethod]
        public async Task UNIVERSAL_TrackEventTest2()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_ProfileUpdateTest1()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_ProfileUpdateTest2()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_ProfileUpdateTest3()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_ProfileUpdateTest4()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_ProfileUpdateTest5()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task UNIVERSAL_RevenueTrackingTest()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
