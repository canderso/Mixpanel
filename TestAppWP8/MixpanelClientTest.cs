...
namespace TestAppWP8
{
    ...
    public class MixpanelClientTest
    {
        ...
        [TestMethod]
        public async Task WP8SL_TrackEventTest1()
        {
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest1()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest2()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest3()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest4()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest5()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP8SL_ProfileUpdateTest6()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
