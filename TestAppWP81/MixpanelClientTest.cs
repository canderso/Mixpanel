...
namespace TestAppWP81
{
    ...
    public class MixpanelClientTest
    {
        ...
        [TestMethod]
        public async Task WP81SL_TrackEventTest1()
        {
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest1()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest2()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest4()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest5()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest6()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_ProfileUpdateTest7()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_RevenueTrackingTest()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
        ...
        [TestMethod]
        public async Task WP81SL_TrySendLocalElementsTest()
        {
            MixpanelClient client = await MixpanelClient.GetCurrentClient();
